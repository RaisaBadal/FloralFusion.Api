...
{
    /// <inheritdoc />
    public partial class MigrateNowhgj : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryOptionName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    MinDeliveryTime = table.Column<int>(type: "int", nullable: true),
                    MaxDeliveryTime = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OccasionType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerOccasions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlowerOccasionId = table.Column<long>(type: "bigint", nullable: false),
                    FlowerOccasionId1 = table.Column<long>(type: "bigint", nullable: false),
                    FlowerCategoryId = table.Column<long>(type: "bigint", nullable: false),
                    FlowerCategoryId1 = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingNumber = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerUser", x => new { x.FlowerId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FlowerUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlowerUser_Flowers_FlowerId",
                        column: x => x.FlowerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlowerId = table.Column<long>(type: "bigint", nullable: false),
                    Flower_Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistItems_Flowers_FlowerId",
                        column: x => x.FlowerId,
                        principalTable: "Flowers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryOptions_MaxDeliveryTime",
                table: "DeliveryOptions",
                column: "MaxDeliveryTime");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryOptions_MinDeliveryTime",
                table: "DeliveryOptions",
                column: "MinDeliveryTime");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryOptions_Price",
                table: "DeliveryOptions",
                column: "Price");

            migrationBuilder.CreateIndex(
                name: "IX_FlowerCategories_CategoryName",
                table: "FlowerCategories",
                column: "CategoryName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FlowerOccasions_OccasionType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTypes_Type",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_FlowerId",
                table: "WishlistItems",
                column: "FlowerId");
